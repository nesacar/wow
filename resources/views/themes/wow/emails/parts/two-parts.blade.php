                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                            <div style="font-family:Roboto;font-size:14px;line-height:1.5;text-align:left;color:#000000;">
                                                <div class="article">
                                                    <h2 class="heading">{{ $post1->title }}</h2>
                                                    <p>{{ substr($post1->short, 0, 70) }}...</p>
                                                    <div style="text-align: right;"> <a href="{{ url($post1->link) }}">Read more &gt;</a> </div>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                            <div style="font-family:Roboto;font-size:14px;line-height:1.5;text-align:left;color:#000000;">
                                                <div class="article">
                                                    <h2 class="heading">{{ $post2->title }}</h2>
                                                    <p>{{ substr($post2->short, 0, 70) }}...</p>
                                                    <div style="text-align: right;"> <a href="{{ url($post2->link) }}">Read more &gt;</a> </div>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
