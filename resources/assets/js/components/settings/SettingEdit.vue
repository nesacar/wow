                    ...
                    <div class="card">
                        ...
                        <form @submit.prevent="submit()">
                            <div class="form-group">
                                ...
                                <input type="text" name="Phone1" class="form-control" id="Phone1" placeholder="Phone 1" v-model="setting.phone1">
                                <small class="form-text text-muted" v-if="error != null && error.phone1">{{ error.phone1[0] }}</small>
                            </div>
                            <div class="form-group">
                                <label for="Phone1">Phone 2</label>
                                <input type="text" name="Phone2" class="form-control" id="Phone2" placeholder="Phone 2" v-model="setting.phone2">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit(){
                axios.patch('api/settings/1', this.setting)
                    .then(res => {
                        swal({
                            position: 'center',
                            type: 'success',
